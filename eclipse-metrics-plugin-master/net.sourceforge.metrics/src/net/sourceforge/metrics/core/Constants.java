...
public interface Constants {
	...
	/**"MCD" */
	public final static String METHOD_COMMENT_DENSITY = "MCD";
	/**"CCD" */
	public final static String CLASS_COMMENT_DENSITY = "CCD";
	
	/**"WCM" */
	public final static String WELL_COMMENTEDNESS_METHOD = "WCM";
	/**"WCC" */
	public final static String WELL_COMMENTEDNESS_CLASS = "WCC";
	/** "NOM" */
